document.addEventListener('DOMContentLoaded', function () {
    ...
    function createBookItem(book) {
        ...
        const removeButton = createActionButton('Delete', 'red', function () {
            removeBook(book.id);
        });

        let toggleButton;
        if (book.isComplete) {
            toggleButton = createActionButton('Unfinished', 'yellow', function () {
                toggleIsComplete(book.id);
            });
        } else {
            toggleButton = createActionButton('Finished', 'green', function () {
                toggleIsComplete(book.id);
            });
        }
